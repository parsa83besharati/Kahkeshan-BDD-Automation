...
public class ConfigReader {
    ...
    private static final String CONFIG_FILE_PATH = "E:/java/Kahkeshan-BDD-Automation/Kahkeshan-BDD-Automation/Kahkeshan-BDD-Automation/src/main/resources/config.properties";
